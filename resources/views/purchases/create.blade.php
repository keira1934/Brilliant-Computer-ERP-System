@extends('layouts.app')
@php $title = 'Create Purchase Order'; $breadcrumb = 'Purchasing / New PO'; @endphp
@section('content')
<div class="page-header">
    <div><h1>Create Purchase Order</h1></div>
...
<div class="grid-2 mb-5" style="align-items:start">
    <div class="card">
        <div class="card-header"><h5 class="card-title">PO Information</h5></div>
        <div class="card-body">
            ...
            <button type="submit" class="btn btn-primary w-100"><i class="bi bi-check-lg"></i> Create Purchase Order</button>
        </div>
    </div>
    <div class="card">
        ...
        <div class="card-body" style="padding:0">
            <table style="width:100%">
                <thead><tr>
                    ...
                    <th style="padding:10px 14px;background:var(--navy-100);color:var(--navy-700);font-size:11px;width:150px">Unit Cost</th>
